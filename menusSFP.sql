...
VALUES('SFP', 'http://192.168.1.6/app', 25, 1, 'fa fa-times')
...
BEGIN
	...
	INSERT INTO CATALOGOS.dbo.tc_menus (tcmenu_id_ap, tcmenu_descrip, tcmenu_parent, tcmenu_url, tcmenu_estatus, tcmenu_order, tcmenu_class, tcmenu_icon)
	VALUES(22,'Condonaciones', 235, '#/collection/report/condonation', 1, 6, '{ active:view.page == "/collection/report/condonation" }', '')
	, (22,'Gestión', 235, '#/collection/report/management', 1, 7, '{ active:view.page == "/collection/report/management" }', '')
